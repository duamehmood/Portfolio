...
const Hero = () => {
    return (
        <div className='w-full md:py-32 py-[50px] text-center bg-gradient-to-b from-[#04071D] via-[#0C0E23] to-[#150430] grid-bg'>
            <div className="container max-w-full">
                <p className='font-[400] text-[16px] sm:tracking-[25%] tracking-[15%] text-[#E4ECFF] uppercase'>Dynamic Web Magic with Next.js</p>
                <h1 className='pt-[20px] pb-[30px] font-[700] lg:text-[72px] md:text-[56px] text-[44px] tracking-[-3.6%] leading-[100%] text-white xl:px-[180px] lg:px-[60px] md:px-[55px] sm:px-[30px] '>Transforming Concepts into Seamless  <span className='text-[#CBACF9]'>User Experiences</span> </h1>
