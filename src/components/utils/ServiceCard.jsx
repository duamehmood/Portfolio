    ...
    return (
        <div className='bg-gradient-to-t from-[#6971A266] to-[#272A3C80]  px-7 py-10 rounded flex flex-col'>
            ...
            <div className='flex items-center gap-4 sm:gap-5 justify-center '>
                <img src={service.icon1} alt={service.icon1} className='w-[60px] md:w-[80px] border-1 border-secondary rounded-full p-2.5' />
                <RiArrowRightLongFill />
                <img src={service.icon2} alt={service.icon2} className='w-[60px] md:w-[80px] border-1 border-secondary rounded-full p-2.5' />
            </div>
